...
3. Click the NR_monitoring dropdown and you will see a list of schema (your list will likely be shorter than what is shown below).  cm_base_layers is an important one and will include many useful background layers. 
...
You should be able to just QMS icons are shown below.  The QMS search feature is important and is show in the middle. 
...
* The most important and useful layers for conservation planning are in two schema in the database, "cm_base_layers" and "sensitivity": 
...
* No specific information provided about what the feature is.
